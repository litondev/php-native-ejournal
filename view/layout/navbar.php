	...
	<div class="row">
		...
		<div class="col-10 pt-2 pb-2 bg-light navbar-mobile">
			<ul class="list-group p-2">
				...
				<?php if(!isset($_SESSION['user'])){ ?>
				<li class="list-group-item">
					<a href="<?php $base_url('/?page=signin');?>">Masuk</a>
				</li>
				<?php } ?>

				<?php if(!isset($_SESSION['user'])){ ?>
				<li class="list-group-item">
					<a href="<?php $base_url('/?page=signup');?>">Daftar</a>
				</li>
				<?php } ?>

				<li class="list-group-item">
					<a href="<?php $base_url('/?page=publish');?>">Publish</a>
				</li>

				<li class="list-group-item">
					<a href="<?php $base_url('/?page=journal-free');?>">Journal Gratis</a>
				</li>

				<li class="list-group-item">
					<a href="<?php $base_url('/?page=journal-pay');?>">Journal Berbayar</a>
				</li>

				<?php if(isset($_SESSION['user'])){ ?>
				<li class="list-group-item">
					<a href="<?php $base_url('/?page=profil');?>">Akun</a>
				</li>
				<?php } ?>				
				
				<?php if(isset($_SESSION['user'])){?>
				<li class="list-group-item">
					<a href="<?php $base_url('/?page=logout');?>">Keluar</a>
				</li>
				<?php } ?>
			</ul>	
		</div>
